...
- [x] trades.json — paper trade ledger
- [x] stats.json — derived analytics
- [x] blog.json — auto-generated article entries
- [x] data/candles/ — intraday 1-min candles per open contract
...
- [x] pages/paper-trade.html
- [x] pages/ledger.html

### Phase 4 — Analytics & Blog
- [x] data/stats.json populated by sell_signal.py
- [x] data/blog.json auto-generated by sell_signal.py
- [x] components/blog-engine.js
- [x] pages/stats.html
- [x] pages/blog.html
